...
class Encoder(MultiHeadAttention):
    ...
    def execute(self, input_text: str):
        ...
        multi_head_attention = self.heads * [MultiHeadAttention(positional_embedding=positional_embedding, len_input_text=self.len_input_text, d_model=self.d_model, output_dim=self.d_model)]
...
if __name__ == '__main__':
    ...
    encoder.execute(input_text='hello world')
    print('Success!')